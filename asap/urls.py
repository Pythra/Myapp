...
from .views import get_coins, fetch_user, delete_user, RegisterDeviceView, ChangePasswordView, verify_email_code, initiate_email_verification, resend_verification_code, NotificationView, ProfileListCreateView, SignupView, LogoutView, ProfileDetailView, GiftCardDetailView, GiftCardListCreateView, ProfileView, BankCreateView, BankListView, BankDetailView
